...
for i in range(NUM):
    ...
    print("\33[92mSPAM BY CYBER-SAFE Done !API-1!")
    threading.Thread(target=api2).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-2!")
    threading.Thread(target=api3).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-3!")
    threading.Thread(target=api4).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-4!")
    threading.Thread(target=api5).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-5!")
    threading.Thread(target=api6).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-6!")
    threading.Thread(target=api7).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-7!")
    threading.Thread(target=api8).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-8!")
    threading.Thread(target=api9).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-9!")
    threading.Thread(target=api10).start()
    print("\33[92mSPAM BY CYBER-SAFE Done !API-10!")
